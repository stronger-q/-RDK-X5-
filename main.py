        ...
        try:
            ...
            while cap.isOpened():
                ...
                if success:
                    ...
                    print("results[0].boxes.id:", results[0].boxes.id)
            ...
            print('category_nums：', self.category_nums)
